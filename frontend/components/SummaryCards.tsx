...
export default function SummaryCards({ balance, income, expense }: SummaryCardsProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div className="bg-gradient-to-br from-emerald-600 to-emerald-700 dark:from-emerald-900 dark:to-emerald-900 p-6 rounded-2xl shadow-xl shadow-indigo-200/50 dark:shadow-none text-white transition-all">
